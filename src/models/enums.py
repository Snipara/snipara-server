"""Enumeration types for Snipara Server."""
...
class ToolName(StrEnum):
    ...
    RLM_LIST_BUSINESS_COLLECTIONS = "rlm_list_business_collections"
    RLM_ENSURE_BUSINESS_COLLECTION = "rlm_ensure_business_collection"
    RLM_UPLOAD_BUSINESS_DOCUMENT = "rlm_upload_business_document"
    RLM_LIST_CLIENT_PROJECTS = "rlm_list_client_projects"
    RLM_CREATE_CLIENT_PROJECT = "rlm_create_client_project"
    ...
    RLM_MEMORY_REVIEW_QUEUE = "rlm_memory_review_queue"
    RLM_MEMORY_RESOLVE_QUEUE_ITEM = "rlm_memory_resolve_queue_item"
    ...
    RLM_MEMORY_HEALTH = "rlm_memory_health"
    RLM_MEMORY_DUPLICATE_CANDIDATES = "rlm_memory_duplicate_candidates"
    RLM_MEMORY_CLEAN_CANDIDATES = "rlm_memory_clean_candidates"
    RLM_MEMORY_DAILY_BRIEF = "rlm_memory_daily_brief"
    RLM_SESSION_MEMORIES = "rlm_session_memories"
    RLM_SESSION_BOOTSTRAP_STATUS = "rlm_session_bootstrap_status"
