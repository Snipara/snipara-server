"""General response models for Snipara Server."""
...
DEFAULT_MEMORY_NOVELTY_THRESHOLD = 0.92


def normalize_memory_novelty_threshold(
    value: Any,
    default: float = DEFAULT_MEMORY_NOVELTY_THRESHOLD,
) -> float:
    """Return a safe novelty threshold even when persisted settings contain null/invalid values."""
...
class ProjectSettings:
    ...
    memory_novelty_threshold: float = DEFAULT_MEMORY_NOVELTY_THRESHOLD
    ...
    def __post_init__(self) -> None:
        self.memory_novelty_threshold = normalize_memory_novelty_threshold(
            self.memory_novelty_threshold
        )
