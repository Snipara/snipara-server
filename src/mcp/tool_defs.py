...
TOOL_TIERS: dict[str, ToolTier] = {
    ...
    "rlm_recall": ToolTier.POWER_USER,
    ...
    "rlm_list_business_collections": ToolTier.TEAM,
    "rlm_ensure_business_collection": ToolTier.TEAM,
    "rlm_upload_business_document": ToolTier.TEAM,
    "rlm_list_client_projects": ToolTier.TEAM,
    "rlm_create_client_project": ToolTier.TEAM,
    ...
    "rlm_session_bootstrap_status": ToolTier.UTILITY,
    "rlm_memory_compact": ToolTier.ADVANCED,
    "rlm_memory_health": ToolTier.POWER_USER,
    "rlm_memory_duplicate_candidates": ToolTier.POWER_USER,
    "rlm_memory_clean_candidates": ToolTier.POWER_USER,
...
TOOL_DEFINITIONS: list[dict] = [
    # ============ Context Retrieval Tools ============
    {
        ...
        "description": (
            "Query project documents, parsed business files, and shared context. Use this first "
            "for source truth and narrative documentation. Returns ranked sections within token "
            "budget. If a broad query times out, retry once with a narrow 3-8 term query, "
            "max_tokens 800-1500, search_mode='keyword', return_references=true, "
            "auto_decompose=false, and include_all_tiers=false. For exact text use rlm_search; "
            "for structural code context use rlm_code_neighbors, rlm_code_callers, or "
            "rlm_code_imports."
        ),
        "inputSchema": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": (
                        "Documentation, business-context, or current-truth question. For timeout "
                        "recovery, narrow this to the key file, feature, symbol, or 3-8 terms."
                    ),
                },
                "max_tokens": {
                    "type": "integer",
                    ...
                    "maximum": 100000,
                    "description": (
                        "Token budget. Use 800-1500 for fast recovery retries after a timeout."
                    ),
                },
                "search_mode": {
                    "type": "string",
                    ...
                    "default": "hybrid",
                    "description": (
                        "Search strategy. Use keyword for fast retry/recovery paths; use hybrid "
                        "for normal documentation discovery."
                    ),
                },
                ...
                "return_references": {
                    "type": "boolean",
                    "default": False,
                    "description": "Return chunk references (IDs + previews) instead of full content. Use rlm_get_chunk to retrieve full content by ID. Reduces hallucination by maintaining clear source attribution and is the preferred fast retry path after a timeout.",
                },
                "auto_decompose": {
                    "type": "boolean",
                    "default": True,
                    "description": "Auto-decompose complex queries into sub-queries (Pro+ only). Complex queries (50+ words, multiple questions, comparisons) are automatically broken down and results merged. Set to False for fast timeout recovery retries.",
                },
                "include_all_tiers": {
                    "type": "boolean",
                    "default": False,
    ...
    # ============ Shared Context Tools ============
    {
        ...
        "description": "Load project-linked shared standards, business playbooks, and reusable guidance. Use for linked source documents, not durable memory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "max_tokens": {
    ...
    },
    {
        ...
        "description": "Upload or update a document in a shared context collection. Use for team best practices, coding standards, business playbooks, reusable examples, and guidelines. Requires Team plan or higher.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "collection_id": {"type": "string", "description": "The shared collection ID"},
    ...
    },
    {
        ...
        "description": "List Team Business Context collections for the current team, including Business Response Playbook, Business Library, Offer Templates, Company Presentations, and Reference Diagrams. Use this before uploading reusable business knowledge.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "include_custom": {
                    "type": "boolean",
                    "default": False,
                    "description": "Also include custom collections that look business-oriented. Preset business collections are always included.",
                },
                "include_missing_presets": {
                    "type": "boolean",
                    "default": True,
                    "description": "Return missing preset definitions so the caller can create them with rlm_ensure_business_collection.",
                },
            },
            "required": [],
        },
    },
    {
        ...
        "description": "Create or return an existing Team Business Context collection. Prefer preset slugs for the standard workspace business library.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "preset": {
                    ...
                    "description": "Standard Team Business Context preset to create or return.",
                },
                "name": {
                    "type": "string",
                    "description": "Custom collection display name. Required when preset is omitted.",
                },
                "slug": {
                    "type": "string",
                    "description": "Custom collection slug. Defaults to a slugified name.",
                },
    ...
    },
    {
        ...
        "description": "Upload or update a reusable document in a Team Business Context collection. For current client/project files with metadata, use rlm_upload_document instead.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "collection_id": {
                    "type": "string",
                    "description": "Business collection ID. If omitted, provide preset or collection_slug.",
                },
                "preset": {
                    "type": "string",
                    "enum": [
                    ...
                    "description": "Business preset to resolve or create before upload.",
                },
                "collection_slug": {
                    "type": "string",
                    "description": "Business collection slug to resolve when collection_id is omitted.",
                },
                "title": {"type": "string", "description": "Document title"},
                "content": {"type": "string", "description": "Document content (usually markdown)"},
                "category": {
                    "type": "string",
                    "enum": ["MANDATORY", "BEST_PRACTICES", "GUIDELINES", "REFERENCE"],
                    "default": "REFERENCE",
                    "description": "Shared-context category used for token budget allocation.",
                },
                "tags": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Tags such as offer, template, diagram, client-example, or methodology.",
                },
                "priority": {
                    "type": "integer",
                    "default": 0,
                ...
                "allow_custom_collection": {
                    "type": "boolean",
                    "default": False,
                    "description": "Allow upload to a custom business-looking collection instead of a standard preset.",
                },
            },
    ...
    },
    {
        ...
        "description": "List client/project business-context workspaces in the current team. These are project-scoped containers for current client documents, deliverables, diagrams, and history.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "include_internal": {
                    "type": "boolean",
                    "default": False,
                    "description": "Also return internal, research, and code projects with their scope classification.",
                },
                "limit": {
                    "type": "integer",
                    "default": 100,
    ...
    },
    {
        ...
        "description": "Create a client/project business-context workspace in the current team. Use this before uploading current client documents with rlm_upload_document.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "name": {"type": "string", "description": "Client/project display name"},
                "slug": {
                    "type": "string",
                    "description": "Optional stable project slug. Defaults to a slugified name.",
                },
                "description": {
                    "type": "string",
                    "description": "Optional description. Snipara prefixes it as Client business context when needed.",
                },
                "project_mode": {
                    "type": "string",
                    "enum": ["active_client", "reference_archive"],
                    "description": "Optional client project mode. active_client keeps business health enabled; reference_archive is for past-client precedent.",
                },
                "external_client_id": {
                    "type": "string",
                    "description": "Optional external client identifier echoed back for integrator workflows.",
                },
            },
            "required": ["name"],
        },
    ...
    # ============ Agent Memory Tools ============
    {
        "name": "rlm_remember",
        "description": (
            "Store a durable Memory V2 record for later semantic recall. Direct writes support "
            "fact, decision, learning, preference, todo, and context. Use the narrowest owner "
            "scope: agent for one agent role, project for one client/project/RFP, team for reviewed "
            "shared standards, and user for one person's preferences. Do not store source truth "
            "here; use rlm_context_query, rlm_load_document, or rlm_shared_context for specs, RFPs, "
            "diagrams, and raw docs. Use rlm_end_of_task_commit for workflow capture."
        ),
        "inputSchema": {
            "type": "object",
            "properties": {
                ...
                "scope": {
                    ...
                    "default": "project",
                    "description": (
                        "Memory owner boundary. scope=agent requires agent_id; scope=user is "
                        "personal to the authenticated user or integrator external_user_id; "
                        "scope=team requires the current project to belong to a team."
                    ),
                },
                "agent_id": {
                    "type": "string",
    ...
    },
    {
        ...
        "description": (
            "Store a durable Memory V2 record only if it is sufficiently novel compared with "
            "existing memories. Direct writes support fact, decision, learning, preference, todo, "
            "and context. Use context tools for source truth and rlm_end_of_task_commit for "
            "workflow capture. Returns duplicate matches when skipped."
        ),
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Persist durable outcomes from a task summary into memory. Extracts decisions, learnings, preferences, todos, and durable workflow context while filtering operational receipts; not for source documents or specs.",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Store multiple durable Memory V2 records in a single call. Batch embedding for "
            "efficiency. Max 50 memories per call. Do not bulk-store source documents; upload or "
            "query source truth through context tools instead."
        ),
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        "name": "rlm_recall",
        "description": (
            "Semantically recall durable Memory V2 records such as decisions, learnings, "
        ...
        "inputSchema": {
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Memory question such as a past decision, preference, or validated learning",
                },
                "type": {
                    "type": "string",
                    "enum": ["fact", "decision", "learning", "preference", "todo", "context"],
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "old_memory_id": {
                    "type": "string",
                    "description": "Legacy or V2 memory ID being replaced",
                },
                "new_memory_id": {
                    "type": "string",
                    "description": "Legacy or V2 replacement memory ID",
                },
    ...
    },
    {
        ...
        "description": "Private review surface for candidate, stale, or rejected memories that need human inspection before they become agent memory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "status": {
                ...
                "search": {"type": "string", "description": "Optional content search filter."},
                "limit": {
                    "type": "integer",
                    "default": 50,
                    "minimum": 1,
                ...
                "include_evidence": {
                    "type": "boolean",
                    "default": True,
                    "description": "Include Memory V2 evidence links and legacy document refs.",
                },
                "agent_id": {
                    "type": "string",
                    "description": "Required when scope=agent; limits queue reads to one agent namespace.",
                },
                "external_user_id": {
                    "type": "string",
                    "description": "Integrator client keys only: stable end-user ID for scope=user queue reads.",
                },
            },
            "required": [],
        },
    },
    {
        ...
        "description": "Private review surface to accept, reject, archive, invalidate, merge, or supersede one queued memory item.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "memory_id": {
                ...
                "target_memory_id": {
                    "type": "string",
                    "description": "Required for merge and supersede actions.",
                },
                "notes": {
                    "type": "string",
    ...
    # ============ Memory Tiers & Compaction Tools (Phase 20) ============
    {
        ...
        "description": "Get tiered durable memories for session bootstrap, with optional short-lived carryover. Use at session start to restore memory state, not to retrieve source documents.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "max_critical_tokens": {
    ...
    },
    {
        ...
        "description": "Read-only status for the current engine session memory bootstrap. Reports whether bootstrap ran, when it ran, and how many memories/profiles were injected.",
        "inputSchema": {
            "type": "object",
            "properties": {},
            "required": [],
    ...
    },
    {
        ...
        "description": "Read-only memory hygiene diagnostics. Returns active memory counts, top categories, auto-compaction threshold status, and samples of known noise/anomaly patterns without mutating memory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "scope": {
                    "type": "string",
                    "enum": ["agent", "project", "team", "user"],
                    "description": "Optional memory scope to inspect. Defaults to all visible project-owned scopes.",
                },
                "include_inactive": {
                    "type": "boolean",
                    "default": False,
                    "description": "Include INVALIDATED and SUPERSEDED memories in the scan.",
                },
                "sample_limit": {
                    "type": "integer",
                    "default": 5,
                    "minimum": 0,
                    "maximum": 20,
                    "description": "Maximum anomaly samples to return.",
                },
            },
            "required": [],
        },
    },
    {
        ...
        "description": "Read-only duplicate/supersession review candidates. Groups exact and near duplicate memories and suggests which IDs to keep or supersede without mutating memory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "scope": {
                ...
                "include_inactive": {
                    "type": "boolean",
                    "default": False,
                    "description": "Include INVALIDATED and SUPERSEDED memories in duplicate grouping.",
                },
                "limit": {
                    "type": "integer",
                    "default": 20,
                ...
                "min_similarity": {
                    ...
                    "minimum": 0,
                    "maximum": 1,
                    "description": "Lexical similarity threshold for near-duplicate groups.",
                },
            },
            "required": [],
        },
    },
    {
        ...
        "description": "Read-only grouped memory cleanup candidates. Returns noise, duplicates, possibly stale memories, category anomalies, and review-queue items without mutating memory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "scope": {
                ...
                "limit_per_bucket": {
                    ...
                    "minimum": 1,
                    "maximum": 50,
                    "description": "Maximum candidates to return per bucket.",
                },
            },
            "required": [],
        },
            ...
            "properties": {
                ...
                "profile": {
                    ...
                    "properties": {
                        "display_name": {
                            "type": "string",
                            "description": "Display name (e.g., 'Jarvis ⚡')",
                        },
                        "personality": {
                            "type": "string",
                            "description": "Personality type (e.g., 'INTJ - Strategic')",
                        },
                        ...
                        "soul_document_path": {
                            "type": "string",
                            "description": "Path to SOUL.md document",
                        },
                        "memory_scope": {
                            "type": "string",
                            "enum": ["agent", "project", "team"],
    ...
    },
    {
        ...
        "description": "Compatibility alias that creates a canonical HierarchicalTask N3 work item. Prefer rlm_htask_create for explicit hierarchical workflows; use this for simple queue-style task creation.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "swarm_id": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Compatibility alias that creates multiple canonical HierarchicalTask N3 work items in one call. Max 50 tasks per call.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "swarm_id": {"type": "string"},
    ...
    {
        "name": "rlm_task_claim",
        "description": "Compatibility alias that claims a canonical HierarchicalTask N3 task. If task_id is omitted, claims the highest-priority available task.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "swarm_id": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Compatibility alias that completes or fails a canonical HierarchicalTask N3 task with legacy queue-style inputs.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "swarm_id": {"type": "string"},
    ...
    {
        "name": "rlm_tasks",
        "description": "Compatibility alias that lists canonical HierarchicalTask N3 tasks with legacy queue-style filters.",
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "status": {
                    "type": "string",
                    "enum": ["pending", "claimed", "completed", "failed", "cancelled", "blocked"],
    ...
    {
        "name": "rlm_task_list",
        "description": """List canonical HierarchicalTask N3 tasks with cursor-based pagination for efficient iteration.
...
This is the queue-style progress view. For full workflow status, use rlm_htask_metrics or rlm_htask_tree.""",
    ...
    },
    {
        ...
        "description": """Get canonical htask status change events for a swarm through the legacy task surface.
...
- claim_timeout: Seconds a resource claim lasts (60-7200)""",
    ...
    },
    {
        ...
        "description": """Reassign a canonical HierarchicalTask N3 task to a different agent through the legacy task surface.
...
COMPLETED/FAILED tasks cannot be reassigned.""",
    ...
    },
    {
        ...
        "description": """Archive a canonical HierarchicalTask N3 task from a swarm through the legacy task surface (admin only).
...
COMPLETED and IN_PROGRESS tasks require force=true.""",
        "inputSchema": {
            ...
            "properties": {
                ...
                "force": {
                    "type": "boolean",
                    "default": False,
                    "description": "Force archive even if task is COMPLETED or IN_PROGRESS (admin only)",
                },
            },
            "required": ["swarm_id", "task_id"],
        },
    },
    {
        ...
        "description": """Update canonical HierarchicalTask N3 properties through the legacy task surface (admin only).
...
admins can approve or deny via the dashboard.""",
    ...
    # ============ RLM Orchestration Tools ============
    {
        ...
        "description": "Load one exact source document by path. Use when you already know the document path and need direct source truth instead of ranked retrieval or memory recall.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "path": {
                    "type": "string",
                    "description": "Exact document path (for example 'docs/api.md' or 'clients/acme/rfp.md')",
                },
            },
            "required": ["path"],
        },
...
Tasks have owners, priorities, acceptance criteria, and evidence requirements.""",
        "inputSchema": {
            ...
            "properties": {
                ...
                "parent_id": {
                    "type": "string",
                    "description": "Parent task ID (required for N1-N3)",
                },
                "priority": {
                    "type": "string",
                    "enum": ["P0", "P1", "P2"],
...
Returns recursive tree structure with all descendants up to max_depth.""",
        "inputSchema": {
            ...
            "properties": {
                ...
                "task_id": {
                    "type": "string",
                    "description": "Root task ID (optional, defaults to all roots)",
                },
                "max_depth": {
                    "type": "integer",
                    "default": 4,
...
Returns prioritized list of unblocked, pending N3 tasks. Filter by feature_id or workstream_type for focused recommendations.""",
        "inputSchema": {
            ...
            "properties": {
                ...
                "feature_id": {
                    "type": "string",
                    "description": "Filter to tasks under this N1 feature",
                },
                "workstream_type": {
                    "type": "string",
                    "enum": [
...
# TOOL_DEFINITIONS is the authoritative list that both the remote MCP surface and
...
EXPOSED_TOOL_DEFINITIONS: list[dict] = [
    tool for tool in TOOL_DEFINITION_BY_NAME.values() if tool.get("exposed", True)
]
