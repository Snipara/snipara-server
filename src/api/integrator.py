    ...
    return {
        ...
        "data": {
            ...
            "pricing": {
                ...
                "usage_summary": summarize_client_bundle_usage(tier, clients),
            },
...
async def list_clients(
    ...
    usage_clients = await db.integratorclient.find_many(where={"workspaceId": workspace.id})
    tier = integrator_info["tier"]
    ...
    return {
        ...
        "data": {
            ...
            "pricing": {
                ...
                "discount_applies_to": "client_bundles",
                "usage_summary": summarize_client_bundle_usage(tier, usage_clients),
            },
            "pagination": {
                "total": total,
                "limit": limit,
