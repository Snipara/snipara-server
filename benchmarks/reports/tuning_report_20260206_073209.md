...
| Metric | Value | Rating |
|--------|-------|--------|
| Precision@5 | 12.0% | Needs Improvement |
| Recall | 22.5% | Needs Improvement |
| NDCG | 0.500 | Acceptable |
| MRR | 0.467 | Acceptable |
| Success Rate | 60.0% | Acceptable |
| **Composite** | **0.292** | Needs Improvement |
