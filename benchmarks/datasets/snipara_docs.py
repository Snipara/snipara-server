...
BASIC_TEST_CASES = [
    {
        ...
        "ground_truth_claims": [
            ...
            "MCP server is deployed on Infomaniak VPS",
        ],
    },
    {
        "id": "core_value_prop",
    ...
    },
    {
        ...
        "context_query": "architecture components snipara-mcp FastAPI server web app deployment Infomaniak VPS Vercel",
        "expected_answer": (
            "1. snipara-mcp (PyPI package) - runs locally on user's machine as MCP stdio server, "
            "translates MCP tool calls to HTTP requests. 2. FastAPI Server on Infomaniak VPS - handles "
        ...
        "relevant_sections": [
            ...
            "snipara-fastapi → Infomaniak VPS",
        ],
        "ground_truth_claims": [
            "snipara-mcp is a PyPI package",
            "snipara-mcp runs locally on user's machine",
            "FastAPI server is deployed on Infomaniak VPS",
            "Web app is deployed on Vercel",
...
MULTI_HOP_TEST_CASES = [
    {
        ...
        "expected_answer": (
            ...
            "request to FastAPI server on Infomaniak VPS. 5. FastAPI validates API key, checks usage limits. "
        ...
        "ground_truth_claims": [
            ...
            "HTTP request to Infomaniak VPS",
            "PostgreSQL on Neon",
